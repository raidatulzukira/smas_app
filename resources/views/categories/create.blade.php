            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-8 text-gray-900">
                    ...
                    <div class="mb-6 border-b pb-4">
                        <h3 class="text-lg font-bold text-gray-800">Informasi Kategori Baru</h3>
                        <p class="text-sm text-gray-500">Silakan masukkan nama kategori aset baru di bawah ini.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('categories.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="name" class="block mt-2 w-full bg-gray-50 focus:bg-white transition" type="text" name="name" :value="old('name')" required autofocus placeholder="Contoh: Kendaraan" />
