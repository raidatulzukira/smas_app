                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="item_name" name="item_name" type="text" class="mt-1 block w-full bg-gray-50 focus:bg-white transition" :value="old('item_name')" required placeholder="Contoh: Iphone 12 Pro" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="item_kode" name="item_kode" type="text" class="mt-1 block w-full bg-gray-50 focus:bg-white transition" :value="old('item_kode')" required placeholder="Contoh: A001" />
                                    ...
                                    <div>
                                        ...
                                        <select name="category_id" id="category_id" class="mt-1 block w-full border-gray-300 bg-gray-50 focus:bg-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm transition" required>
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="brand" name="brand" type="text" class="mt-1 block w-full bg-gray-50 focus:bg-white transition" :value="old('brand')" placeholder="Contoh: Apple" />
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Stock -->
                                    <div>
                                        <x-input-label for="stock" :value="__('Stok Awal')" class="text-gray-700 font-semibold" />
                                        <x-text-input id="stock" name="stock" type="number" class="mt-1 block w-full bg-gray-50 focus:bg-white transition" :value="old('stock', 0)" required min="0" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="price" name="price" type="number" class="mt-1 block w-full bg-gray-50 focus:bg-white transition" :value="old('price', 0)" required min="0" />
                            ...
                            <div>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <textarea id="description" name="description" rows="4" class="mt-1 block w-full border-gray-300 bg-gray-50 focus:bg-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm transition" placeholder="Tambahkan deskripsi barang di sini...">{{ old('description') }}</textarea>
                                    ...
                                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <p class="text-xs text-gray-400 mt-2">Format didukung: JPG, PNG, JPEG.</p>
